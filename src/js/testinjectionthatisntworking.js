...
const cssIncludes = [ './style/photoswipe.css',
            './style/default-skin.css',
            './style/noty.css',
            './style/relax.css'  ];
var head = document.getElementsByTagName('HEAD')[0];
function incCSS (path) {
  console.log('we got here sucessfully');
  console.log(path);
...
cssIncludes.forEach(incCSS);

//okay so this is now linking correctly, but obviously the page
//can't find the relative filepaths





//figure out how to get this injection working without enormous
